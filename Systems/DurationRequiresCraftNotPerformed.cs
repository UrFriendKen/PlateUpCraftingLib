...
namespace CraftingLib.Systems
{
    ...
    public class DurationRequiresCraftNotPerformed : GameSystemBase, IModSystem
    {
        ...
        protected override void Initialise()
        {
            ...
            Durations = GetEntityQuery(new QueryHelper()
                .All(typeof(CAppliancePartCraftStation), typeof(CTakesDuration), typeof(CCraftPerformed)));
        }
